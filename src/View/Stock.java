...
public class Stock extends javax.swing.JDialog {
    ...
    public Stock(java.awt.Frame parent, boolean modal) {
        ...
        setResizable(false);
        modelo = new DefaultTableModel(null,new String[]{"N°","Código","Producto","Stock"});
        tabla.setModel(modelo);
        tabla.getColumnModel().getColumn(0).setPreferredWidth(38);
        tabla.getColumnModel().getColumn(1).setPreferredWidth(43);
        tabla.getColumnModel().getColumn(2).setPreferredWidth(293);
    ...
    private void add(String like){
        ...
        DProducto.addProducto(modelo, like);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("cantidad de producto ingresado");
        ...
        jLabel2.setText("seleccione la fila de producto que desea actualizar el stock");
    ...
    private void baceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baceptarActionPerformed
        if(!txcantidad.getText().equals("0")){
            DProducto.updateStock(modelo.getValueAt(tabla.getSelectedRow(), 1).toString(), Integer.parseInt(txcantidad.getText()));
    ...
    private void txcantidadKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txcantidadKeyReleased
        if(txcantidad.getText().length()==0 || txcantidad.getText().equals("0")){
            txcantidad.setText("0");
            txcantidad.selectAll();
        }
